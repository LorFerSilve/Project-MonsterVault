...
**Game Design Specification — DESIGN COMPLETE / Technical Architecture TA-0..17 COMPLETE / IMPLEMENTATION OPEN — IMP-1 through IMP-4 complete; IMP-5 next.**
...
- **Gameplay implementation: OPEN — IMP-1 through IMP-4 complete; IMP-5 Minimal Runtime World next**
...
The active dependency is **IMP-5 — Minimal Runtime World**. Production release remains gated by the downstream implementation phases and TA-15/TA-14 evidence.
