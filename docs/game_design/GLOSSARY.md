...
### Vault
The player's persistent personal base/laboratory space used for creature storage, display, production and progression functions. Final scope remains under design.
...
### Trading
An explicit player-to-player ownership transfer mechanism governed by the trading specification. Trading is not considered implemented or guaranteed until its design gate is complete.
