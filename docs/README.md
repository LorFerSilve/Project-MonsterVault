...
> **Project phase:** Pre-implementation specification — GDS-5 next  
...
- [`game_design/creatures/04_creatures_collection_and_ownership.md`](game_design/creatures/04_creatures_collection_and_ownership.md);
- [`game_design/GDS4_SCENARIO_VALIDATION.md`](game_design/GDS4_SCENARIO_VALIDATION.md);
- [`game_design/GDS4_CROSS_VALIDATION.md`](game_design/GDS4_CROSS_VALIDATION.md);
- [`game_design/GDS4_CLOSURE_REPORT.md`](game_design/GDS4_CLOSURE_REPORT.md).
...
- GDS-5 through GDS-16 have completed their owning design work;
